...
const bookingListItemActive = ({ navigation, detail }) => {

    return (
        <TouchableOpacity onPress={() => navigation.navigate("bookingDetail", { type: 1, detail: detail })} style={styles.container} >
...
export default bookingListItemActive
