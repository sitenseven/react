...
const bookingListItemCanceled = ({ detail, navigation }) => {
    ...
    return (
        <TouchableOpacity onPress={() => navigation.navigate("bookingDetail", { type: 4, detail: detail })} style={styles.container} >
            <View style={styles.headerRow}>
                <View style={styles.labelContainer}>
                    <Text style={styles.labelText} >Cancelled</Text>
                </View>
                <View />
            </View>
...
export default bookingListItemCanceled
