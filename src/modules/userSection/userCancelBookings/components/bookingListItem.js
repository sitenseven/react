...
const bookingListItem = ({  navigation, detail }) => {
    ...
    return (
        <TouchableOpacity onPress={() => navigation.navigate("bookingDetail", { type: 3, detail: detail })} style={styles.container} >
            ...
            <View style={{ width: '100%', height: 30, alignItems: 'center', justifyContent: 'center', borderTopColor: '#15488F26', borderTopWidth: 1 }}>
                <Text style={styles.takingStyle} >Booking cancellation initiated</Text>
            </View>
        </TouchableOpacity>
    )
}
