...
const sporforyaMsgItem = ({ navigation, data }) => {
    ...
    return (
        <TouchableOpacity onPress={() => navigation.replace("chatWithSfy")} style={styles.container}>
            <View style={{ width: wp('5') }} />
            <Image source={require('../../../assets/images/sfyChatLogo.png')} style={{ width: wp('12'), height: wp('12') }} />
            <View style={{ width: 10 }} />
            <View style={{ width: wp('73'), }} >
                <View style={{ width: wp('73'), flexDirection: 'row', justifyContent: 'space-between' }}>
                    <Text numberOfLines={1} style={styles.nameStyle} >Sporforya Support</Text>
