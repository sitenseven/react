        ...
        <View style={styles.container} >
            ...
            <ScrollView contentContainerStyle={{ width: wp('100'), alignItems: 'center', paddingBottom: 20 }} >
                ...
                <View style={styles.subContainer} >
                    ...
                    <Text style={styles.subHeading} >Please choose your cancellation and refund policy that works best for your event</Text>
                    {
                        policyList != null
                            ?
                    ...
                    <TouchableOpacity
                        onPress={() => props.navigation.navigate("editCreateCancellationPolicyEvent", { recordId: recordId })}
                    ...
                    <Btn label="Continue" onClick={() => props.navigation.navigate("editReleaseLiabilityEvent", { recordId: recordId })} bgColor="#2C99C6" />
