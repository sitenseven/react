        ...
        <View style={styles.container} >
            ...
            <ScrollView contentContainerStyle={{ width: wp('100'), alignItems: 'center', paddingBottom: 20 }} >
                ...
                <View style={styles.subContainer} >
                    ...
                    <Text style={styles.subHeading} >Enter the dates, days, times, and other particulars for your service</Text>
                    <Text style={styles.subHeading1} >You have the option to add multiple schedules for your service, using different dates, days, andtimes</Text>
                    <Text style={styles.subHeading1} >Note: If your service has multiple locations, then a new listing must be created for each location</Text>
                    ...
                    <View style={{ width: wp('80'), marginTop: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }} >
                        <View>
                            ...
                            <CustomTimePicker value={startTime} getValue={getStartTime.bind(this)} />
                        </View>
                        <View>
                            <Text style={[styles.labelStyle, { width: wp('37.5') }]} >End time</Text>
                            <CustomTimePicker value={endTime} getValue={getEndTime.bind(this)} />
                        </View>
                    </View>
                                ...
                                <View style={{ width: wp('80'), marginTop: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }} >
                                    ...
                                    <View>
                                        ...
                                        <View style={{ flexDirection: 'row', }} >
                                            <ModalSelector
                                                selectStyle={{ width: wp('37.5'), height: 46, backgroundColor: '#FFFFFF', borderColor: '#70707026', borderRadius: 4, justifyContent: 'center', alignItems: 'center' }}
                                                style={{ width: wp('30'), height: 46, backgroundColor: '#FFFFFF', }}
                                                selectTextStyle={{ color: '#707070', fontSize: wp('3.5'), fontFamily: FONTS.SFRegular }}
                                                initValueTextStyle={{ color: '#707070', fontSize: wp('3.5'), fontFamily: FONTS.SFRegular }}
                                                data={repeatData}
                                                initValue="select"
                    ...
                    <View style={{ width: wp('80'), marginTop: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }} >
                        ...
                        <View>
                            ...
                            <View style={{ flexDirection: 'row', }} >
                                <ModalSelector
                                    selectStyle={{ width: wp('30'), height: 46, backgroundColor: '#FFFFFF', borderColor: '#70707026', borderRadius: 4, justifyContent: 'center', alignItems: 'center' }}
                                    style={{ width: wp('30'), height: 46, backgroundColor: '#FFFFFF', }}
                                    selectTextStyle={{ color: '#707070', fontSize: wp('3.5'), fontFamily: FONTS.SFRegular }}
                                    initValueTextStyle={{ color: '#707070', fontSize: wp('3.5'), fontFamily: FONTS.SFRegular }}
                                    data={data}
                                    initValue="select"
                                    onChange={(option) => { setPricePer(option.key) }} />
                                <Image source={ICONS.downArrow} style={{ width: 10, height: 10, position: 'absolute', right: 12, marginTop: 20 }} resizeMode="contain" />
                            </View>
                        </View>
                    </View>
