...
const addService = props => {
    ...
    const uploadServiceDetail = () => {
        if (selectSport == "Select") {
            ...
            alert('Should select event type');
        } else if (serviceName == '') {
            alert('Event title field should not be blank');
        } else if (serviceDesc == '') {
            alert('Event Description field should not be blank');
        } else if (aboutStaff == '') {
            alert('The Event Venue field should not be blank');
