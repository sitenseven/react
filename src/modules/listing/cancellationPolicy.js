        ...
        <View style={styles.container} >
            ...
            <ScrollView contentContainerStyle={{ width: wp('100'), alignItems: 'center', paddingBottom: 20 }} >
                <View style={styles.subContainer} >
                    ...
                    <TouchableOpacity
                        onPress={() => props.navigation.navigate("createCancellationPolicy", { recordId: recordId })}
                    ...
                    <Btn label="Continue" onClick={() => props.navigation.navigate("releaseLiability", { recordId: recordId })} bgColor="#2C99C6" />
