        ...
        <View style={styles.container} >
            ...
            <ScrollView contentContainerStyle={{ width: wp('100'), alignItems: 'center', paddingBottom: 20 }} >
                <View style={styles.subContainer} >
                    ...
                    <Text style={styles.subHeading} >Please choose your cancellation and refund policy that works best for your service</Text>
                    {
                        policyList != null
                            ?
                    ...
                    <TouchableOpacity
                        onPress={() => props.navigation.navigate("editCreateCancellationPolicy", { recordId: recordId })}
                    ...
                    <Btn label="Continue" onClick={() => props.navigation.navigate("editReleaseLiability", { recordId: recordId })} bgColor="#2C99C6" />
