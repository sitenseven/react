...
const theme = '#21D17F';
const border = '#BDDBE8';
const customTitleDropdown = ({ item, label, placeHolder, getValue, }) => {
            ...
            </TouchableOpacity>
            {
                active
                    ...
                    <View style={{ width: wp('80'), flexDirection: 'row', flexWrap: 'wrap' }} >
                        {list.map((item, index) => {
                            return (
                                <View key={index} style={{ padding: 4, backgroundColor: '#61B2D4', margin: 7, borderRadius: 3, justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
